...
client.on("message", message => {
  ...
  if (message.content === prefix + "2help") {
    ...
    message.author.sendMessage(` ✽ **__Premium Bot F4__**
...
client.on("message", message => {
  ...
  if (message.content === prefix + "help") {
    message.channel.send(`  **__Premium Bot F4__** 

> **Help | Menu**
----------------------------
 ** __%1help__ ** ** الاوامر العامه **
 ** __%2help__ ** ** الاوامر الإداريه  **
 ** __%3help__ ** ** أوامر الموسيقى  **
